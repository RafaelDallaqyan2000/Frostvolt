...
const ENEMIES = {
 "normal": {"name": "Трутень", "hp": 46.0, "speed": 48.0, "damage": 5.0, "interval": 1.4, "size": 20.0, "lift": 28.0, "armor": 0.0, "color": Color("f38373")},
 "runner": {"name": "Шершень", "hp": 24.0, "speed": 92.0, "damage": 4.0, "interval": 1.0, "size": 14.0, "lift": 0.0, "armor": 0.0, "flying": true, "color": Color("f8cb6b")},
 "heavy": {"name": "Панцирник", "hp": 220.0, "speed": 36.0, "damage": 12.0, "interval": 2.0, "size": 30.0, "lift": 40.0, "armor": 4.0, "color": Color("b898fc")},
 "boss": {"name": "Носитель", "hp": 1300.0, "speed": 24.0, "damage": 16.0, "interval": 2.4, "size": 84.0, "lift": 150.0, "armor": 2.0, "slow_factor": 0.85, "color": Color("ff507e")}}
